<?php namespace es\fdi\ucm\aw\gamersDen;
     ...
     */
    class FormularioBusquedaForo extends FormularioGestionManual{
        /**
        ...
        public function __construct(){
            parent::__construct('formBusquedaForo', [
                'method' => 'GET',
                'action' => 'mostrarBusquedaForo.php'
            ]);
        }
        ...
        protected function procesaFormulario(&$datos) {
            ...
            if (count($this->errores) === 0) {
                ...
                $resultado['foros'] = Foro::buscarForoKeyWords($keyWords);
